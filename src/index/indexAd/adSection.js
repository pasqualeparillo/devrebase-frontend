...
export default function AdSection() {
  return (
    <div
      className="lg:w-8/9 md:w-8/9 w-full flex lg:flex-row flex-col flex-wrap self-center justify-between lg:flex-no-wrap flex-wrap lg:p-12 p-6 relative bg-black mb-24 mt-24"
      style={{ maxWidth: "1440px" }}
    >
      <div className="flex flex-col lg:w-1/2 w-full h-full justify-between lg:items-center lg:p-16">
        <p className="text-white font-black lg:text-6xl text-3xl">
          What is Devrebase?{" "}
        </p>
      </div>
      <div className="flex flex-col lg:w-1/2 w-full h-full items-start lg:py-16 py-10 lg:pr-16">
        ...
        <div className="lg:w-2/3 w-full flex items-center content-center">
          <p className="font-base text-sm leading-loose text-gray-300 mt-8">
            Interact with your users on the platforms they prefer. Web and
            mobile - we have you covered.
          </p>
        </div>
