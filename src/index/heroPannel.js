		...
		<React.Fragment>
			<MediaQuery minWidth={992}>
				<div className="lg:w-2/6 flex z-50">
					...
					>
						<div className="flex w-full justify-end relative pb-12">
							<p
						...
						{[0, 1, 2, 3].map(id => <HeroCard key={id} />)}
					</motion.div>
				</div>
			</MediaQuery>
			...
			<MediaQuery maxWidth={992}>
				<div className="w-full flex z-50 mt-20">
					...
					>
						<div className="flex w-full justify-end relative pb-8">
							<p
...
function HeroCard() {
	...
	return (
		...
		>
			...
			<p className="w-full text-sm text-tan-400 font-bold lg:py-2 py-1 uppercase">Company</p>
			<p className="w-full font-medium text-xl">Junior - Software Engineer</p>
			<p className="w-full text-xs text-gray-500 font-semibold lg:py-4 py-2">April, 24, 2019 - Seattle, WA</p>
		</motion.div>
	);
}
		...
		<React.Fragment>
			...
			<MediaQuery maxWidth={992}>
				<AnimatePresence>
					{isHovered && (
						<motion.div
							className="absolute w-3/4 h-48 bg-tan-400 z-50 border border-black flex self-center p-6 z-20 shadow-2xl"
