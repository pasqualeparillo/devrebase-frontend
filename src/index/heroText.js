		...
		<div className="flex flex-col lg:w-full w-4/5">
			<div className="relative overflow-hidden z-10 ">
				<motion.p
					...
					animate={{ y: 0 }}
					initial={{ y: 200 }}
					transition={{ type: 'spring', mass: 1.5, damping: 50 }}
				>
					Find the most <br />{' '}
				</motion.p>
			</div>
			<div className="relative overflow-hidden">
				<motion.p
					...
					animate={{ y: 0 }}
					initial={{ y: 200 }}
					transition={{ type: 'spring', mass: 1.5, damping: 50, delay: 0.15 }}
				>
					<span className="border-b-8" style={{ borderColor: 'rgb(255, 132, 115)' }}>
						exciting
					</span>{' '}
					startup jobs.
				</motion.p>
