...
import "../index.css";
export default function IndexAdCard() {
  ...
  return (
    ...
    >
      <div
        className="w-full relative whitespace-normal"
      ...
      <div className="w-full flex flex-col border-r border-l border-b rounded-b bg-white">
        <div className="lg:py-6 md:py-6 py-4 px-4">
          <p
            className={isHovered ? `text-xl underline` : `text-xl`}
            style={{ color: "blue" }}
          >
            Fully custom spaces
          </p>
        </div>
        <div className="lg:pt-2 lg:pb-12 md:pb-12 pb-4 px-4 flex">
          <p className="lg:text-base md:text-base text-sm leading-loose ">
            Whole buildings to full.
          </p>
        </div>
      </div>
    </div>
