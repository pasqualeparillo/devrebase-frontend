	...
	return (
		<div className="flex items-center justify-end w-2/3">
			...
			<div className="h-10 flex items-center">
				<input
					className="h-full border-px border-black px-4 py-1 rounded-bl-lg rounded-tl-lg"
					type="text"
					placeholder="Your email address"
				/>
				<motion.button
					className="h-full bg-black font-semibold text-white px-10 py-1 rounded-br-lg rounded-tr-lg border-t-px border-b-px border-r-px border-black"
