				...
				<motion.div className="w-full flex py-8 px-4 rounded-sm border-b cursor-pointer">
					<div className="flex flex-wrap flex-1" style={{ flexBasis: '10%' }}>
						<div className="w-full">
							<p className="lg:text-xl text-sm font-bold break-all" style={{ maxWidth: '80%' }}>
								{title}
							</p>
						</div>
					...
					<div className="flex flex-wrap justify-center flex-1">
						...
						<button className="bg-tan-400 px-6 py-2 h-12" onClick={() => setIsActive(!isActive)}>
							Details
						</button>
					</div>
					<div className="flex flex-wrap justify-center flex-1">
					...
					<div className="flex items-center w-1/6 flex-1 justify-center">
				...
				<motion.div className="w-full flex py-8 px-4 rounded-sm border-b-2 cursor-pointer">
					<div className="flex flex-wrap flex-1">
						<div className="w-1/2 flex flex-wrap items-center">
							...
							<p className="lg:text-base text-sm font-bold w-full py-1">{company}</p>
							<p className="text-gray-500 lg:text-base text-xs py-2">{id} day ago</p>
						</div>
						...
						<div className="w-1/4 flex flex-wrap">
							<div className="w-full flex items-center">
								<Modal isActive={isActive} />
								<button className="bg-tan-400 px-2 py-2" onClick={() => setIsActive(!isActive)}>
									Details
								</button>
							</div>
						</div>
