...
export function BasicButton({ text, opposite }: ButtonProps) {
  return (
    <div
      className={
        opposite === true
          ? "relative button ml-2 mr-2 bg-white border-2 border-black font-black hover:text-white hover:bg-black flex flex-grow"
          : "relative button ml-2 mr-2 bg-black border-2 border-black font-black hover:text-black hover:bg-black flex flex-grow"
      }
    >
      <motion.button
        variants={variant}
